<template>
  ...
  >
      ...
      >
        <v-card class="pa-6 elevation-2 rounded-xl">
          ...
          <v-card-text>
            ...
            >
              <v-radio
                label="Add Ship-From for Existing Pay-To"
                value="existing"
              />
              <v-radio
                label="Add New Pay-To Only"
                value="new"
              />
            </v-radio-group>
            ...
            >
              ...
              <v-card-text>
                ...
                <p v-if="selectedVendor.addressLine2">
            ...
            <div
              v-if="updatedMessage"
              class="my-6 text-green-darken-2 font-weight-bold text-h6"
            >
              {{ updatedMessage }}
            </div>
            <div
              v-if="shipFromVendors?.length"
              class="mt-8"
            >
                ...
                >
                  ...
                  >
                    <v-card-title
                      ...
                      style="font-size: 1.2rem; color: dodgerblue;"
                    >
    ...
    >
          ...
          >
            ...
            <v-card-text>
              <v-row dense>
                ...
                >
                  <v-text-field
                    v-model="newPayTo.name"
                    label="Name"
                    outlined
                    dense
                    @blur="() => onNameInput(newPayTo.name)"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    v-model="newPayTo.addressLine1"
                    label="Address Line 1"
                    outlined
                    dense
                    @blur="newPayTo.addressLine1 = newPayTo.addressLine1.toUpperCase()"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    v-model="newPayTo.defaultShipVia"
                ...
                >
                  <v-text-field
                    v-model="newPayTo.backOrderDays"
                    label="Back Order Days"
                    type="number"
                    outlined
                    dense
                  />
      ...
      <div
        v-if="updatedMessage"
        class="my-6 text-red-darken-2 font-weight-medium white-space-pre-line"
      >
        {{ updatedMessage }}
      </div>
    </v-container>
                      ...
                      <v-row>
                        <v-col cols="12">
                          <v-btn
                            text
                            small
                            @click="form[vendorCode].showAdvanced = !form[vendorCode].showAdvanced"
                          >
                      ...
                      <v-expand-transition>
                        <div v-if="form[vendorCode].showAdvanced">
                          ...
                          >
                            ...
                            >
                              <v-text-field
                                v-model="form[vendorCode].countryCode"
                                label="Country Code"
                                outlined
                                dense
                              />
                            ...
                            >
                              <v-text-field
                                v-model="form[vendorCode].sortBy"
                                label="Sort By"
                                outlined
                                dense
                              />
                            ...
                            >
                              <v-text-field
                                v-model="form[vendorCode].payToId"
                                label="Pay-To ID"
                                outlined
                                dense
                                disabled
                            ...
                            >
                              <v-text-field
                                v-model="form[vendorCode].defaultShipVia"
                                label="Default Ship Via"
                                outlined
                                dense
                              />
                            ...
                            >
                              <v-text-field
                                v-model="form[vendorCode].freight"
                                label="Freight Terms"
                                outlined
                                dense
                                disabled
                            ...
                            >
                              <v-text-field
                                v-model="form[vendorCode].defaultTerms"
                                label="Default Terms"
                                outlined
                                dense
                              />
                            ...
                            >
                              <v-text-field
                                v-model="form[vendorCode].backOrderDays"
                                label="Back Order Days"
                                type="number"
                                outlined
                                dense
